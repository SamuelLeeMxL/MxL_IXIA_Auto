...
host_ip = '192.168.88.66'   #192.168.88.55 ; 192.168.88.66
username = 'teladmin'       #teladmin      ; teladmin
password = '123456'         #telpwd        ; 123456
...
frameRate_rate = 99
frameRate_rate2 = 99
CSports = [1,6]                   #Single port=>80m     #[1,6] means 100M,1M
portspeeds = ['speed2.5g','speed1000']      #Single rate          #Two test rate ['speed2.5g','speed1000']
testtimes = 101
loops = 1
ArduinoIP = "192.168.88.78"

################################################################################
# PopWindow
################################################################################
import PopWindow
logger.info(globals.str5)

import Comport
Console = Comport.Comport()
...
CSports = [1, 2, 3, 4, 5, 6]            #100M,80M,60M,50M,30M,1M
...
# CSports = [2]            #100M,80M,60M,50M,30M,1M
